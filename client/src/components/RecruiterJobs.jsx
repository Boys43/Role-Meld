        ...
        <div className='w-full p-6 h-[calc(100vh-4.6rem)] rounded-lg overflow-y-auto '>
            <div className='p-4 bg-white border rounded-lg shadow-lg'>
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center'>
                    <div className='flex shadow-2xl flex-1 flex-col items-center gap-2 py-4 px-8 border-2 border-green-500 bg-green-300 rounded-2xl'>
                    ...
                    <div className='flex flex-1 shadow-2xl flex-col items-center gap-2 py-4 px-8 border-2 border-red-500 bg-red-300 rounded-2xl'
                    ...
                    <div className='flex flex-1 shadow-2xl flex-col items-center gap-2 py-4 px-8 border-2 border-yellow-500 bg-yellow-300 rounded-2xl'
                    ...
                    <table className="w-full border shadow-lg rounded-lg overflow-x-scroll">
                        <thead>
                            <tr className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-left">
                                ...
                                <th className="px-6 py-3 text-sm font-semibold">Active</th>
                        ...
                        <tbody>
                            {filteredJobs.map((job, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-3 font-medium text-gray-700">{job.title}</td>
